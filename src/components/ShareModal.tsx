...
import {Copy, Facebook, Mail, MessageCircle, MessageSquare, Send, Twitter, X} from "lucide-react";
                                    ...
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <div className="flex flex-col space-y-2">
                                                <div
                                                    className="flex flex-col gap-1 p-2.5 bg-background border rounded-md min-h-20 justify-start">
